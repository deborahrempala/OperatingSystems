...
{
    public partial class modifySpecialOrders : Form
    {
  ...
  SocketType.Stream, ProtocolType.Tcp);
        ...
        private void modifySpecialOrders_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            byte[] lastName = Encoding.ASCII.GetBytes(textBox3.Text);
            int lastNameSent = Mysender.Send(lastName);
            int commaSent1 = Mysender.Send(comma);
            byte[] itemName = Encoding.ASCII.GetBytes(textBox2.Text);
